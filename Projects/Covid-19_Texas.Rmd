...
covid <- read.csv("C:/Users/samue/Documents/College Notes/PyRe/Data sets/us-counties.csv")
glimpse(covid)
...
txcovid_travis %>% 
  ...
  geom_line() +
  ggtitle("Travis County: Change in Covid-19 Cases March 13 - October 18")
...
txcovid_travis %>% 
  ...
  ggtitle("Travis County: Change in Covid-19 Deaths March 13 - October 18")
...
txcovid_harris %>%
  ggplot(aes(x = date, y = diff_cases)) +
  geom_line() +
  ggtitle("Harris County: Change in Covid-19 Cases March 5 - October 18")

# Difference of Covid-19 deaths over time for Harris County
txcovid_harris %>% 
  ggplot(aes(x = date, y = diff_deaths)) +
  geom_bar(stat = "identity") +
  ggtitle("Harris County: Change in Covid-19 Deaths March 5 - October 18")
...
txcovid_bexar %>% 
  ggplot(aes(x = date, y = diff_cases)) +
  geom_line() +
  ggtitle("Bexar County: Change in Covid-19 Cases February 12 - October 18")

# Difference of Covid-19 deaths over time for Bexar County
txcovid_bexar %>%
  ggplot(aes(x = date, y = diff_deaths)) + 
  geom_bar(stat = "identity") +
  ggtitle("Bexar County: Change in Covid-19 Deaths February 12 - October 18")
...
txcovid_dallas %>%
  ggplot(aes(x = date, y = diff_cases)) +
  geom_line() +
  ggtitle("Dallas County: Change in Covid-19 Cases March 10 - October 18")
...
txcovid_dallas %>% 
  ...
  ggtitle("Dallas County: Change in Covid-19 Deaths March 10 - October 18")
...
txcovid_elpaso %>% 
  ggplot(aes(x = date, y = diff_cases)) +
  geom_line() + 
  ggtitle("El Paso County: Change in Covid-19 Cases March 13 - October 18")
...
txcovid_elpaso %>% 
  ...
  ggtitle("El Paso County: Change in Covid-19 Deaths March 13 - October 18")
...
cmap2 <- cmap +
  scale_fill_gradient(low = "#FEDFDF", high = "#FD100F",
                      breaks = c(150000, 125000, 100000, 75000, 50000, 25000),
